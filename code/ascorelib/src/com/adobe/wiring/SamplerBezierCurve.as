...
package com.adobe.wiring
{
  ...
  final public class SamplerBezierCurve extends Sampler implements IBinarySerializable
  {
    ...
    public static const ERROR_DIMENSION:Error =
      new Error( "Dimension of animation curve must be at least 2." );
    
    public static const ERROR_BAD_DATA:Error =
      new Error( "Number of elements for times, points, ins, and outs don't match." );
