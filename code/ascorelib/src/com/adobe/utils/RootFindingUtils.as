...
package com.adobe.utils
{
  ...
  //  Class
  // ---------------------------------------------------------------------------
  public final class RootFindingUtils
  {
    // ========================================================================
    //  Constants
    // ------------------------------------------------------------------------
     ...
     * <p><a href="http://wikipedia.org/wiki/Machine_epsilon">
     * http://wikipedia.org/wiki/Machine_epsilon</a></p>
     */
    public static const MACHINE_EPSILON:Number = 2e-16;
    
    private static const ERROR_BRENTS_INPUT:Error =
      new Error( "The function brentsMethod assumes that f(a) and f(b) have different signs." );
    
    private static const ERROR_OVER_MAX_ITERATIONS:Error =
