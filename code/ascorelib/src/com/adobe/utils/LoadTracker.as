...
package com.adobe.utils
{
  ...
  public final class LoadTracker
  {
    ...
    // ------------------------------------------------------------------------
    /** @private **/
    protected static const ERROR_UNSUPPORTED_IMAGE_FORMAT:Error =
      new Error( "Unsupported image format." );
    
    /** @private **/
    protected static const REGEXP_IMAGE_EXT_NATIVE:RegExp =
      /^.+\.((?:gif)|(?:jpeg)|(?:jpg)|(?:png)|(?:jpe)|(?:jif)|(?:jfif)|(?:jfi))$/i;
    
    protected static const REGEXP_IMAGE_EXT_CUSTOM:RegExp =
      /^.+\.((?:tga)|(?:targa)|(?:tif)|(?:tiff))$/i;
