...
package com.adobe.utils
{
  ...
  //  Class
  // --------------------------------------------------------------------------
  public final class IndexHashMap
  {
    // ========================================================================
    //  Constants
    // ------------------------------------------------------------------------
    protected static const ERROR_BAD_STRIDE:Error =
      new Error( "Bad stride value for IndexHashMap!" );
    
    protected static const ERROR_BAD_INDEX_LENGTH:Error =
      new Error( "Bad index list length for IndexHashMap!" );
    ...
    //  Constructor
    // ------------------------------------------------------------------------
    public function IndexHashMap(
      size:uint, stride:uint, outIndices:Vector.<uint> )
    {
      _size = size;
      _stride = stride;
    ...
    // ------------------------------------------------------------------------
    /**
     * Insert an index grouping into the hash table.
     * Returns the unified index.
     */
