...
package com.adobe.utils
{
   ...
   * 
   */
  public final class VertexHashMap
  {
    // ========================================================================
    //  Constants
    // ------------------------------------------------------------------------
    private static const ERROR_BAD_STRIDE:Error =
      new Error( "Bad stride value for VertexHashMap!" );
    
    private static const ERROR_BAD_VERTEX_LENGTH:Error =
      new Error( "Bad vertex list length for VertexHashMap!" );
    ...
    private var _table:Vector.<Vector.<uint>>;
