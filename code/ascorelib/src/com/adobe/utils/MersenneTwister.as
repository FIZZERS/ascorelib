...
{ 
   ...
   * <p><a href="http://wikipedia.org/wiki/Mersenne_twister">
   * http://wikipedia.org/wiki/Mersenne_twister</a></p>
   */
  public final class MersenneTwister
  {
    ...
    /**
     * Generate a pseudo-random integer on the interval [0,0xffffffff].
    ...
    /**
     * Generates a pseudo-random integer on the interval [0,0x7fffffff].
     * @return A pseudo-random integer.
     */ 
    ...
    /**
     * Generates a pseudo-random real number on the interval of [0,1).
    ...
    /**
    * Generate a pseudo-random integer on interval [high,low]. 
     * @param low
     * @param high 
     * @return A pseudo-random number low and high.
     */
     ...
     * @return A value from a randomly selected position in the provided Array.
     */
    public function selectOne( array:Array ):*
    {
      return array[ inRange( 0, array.length ) ];
    }
