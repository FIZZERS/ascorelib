...
package com.adobe.utils
{
  ...
  public class XMLUtils
  {
    ...
    // ------------------------------------------------------------------------
    /**
    * Parses an XML color stxml color string
     */
    ...
    /**
     * Parses an XML object as a Number.
     * @param xml Input XML.
     * @param defaultValue Default numeric value.
     * @return Returns the numeric content of the XML or if the XML doesn't
     * contain a valid number will return defaultValue.
     */
