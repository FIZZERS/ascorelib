...
package com.adobe.binary
{
  ...
  //  Class
  // ---------------------------------------------------------------------------
  final internal class ValueUnsignedShortVectorVector extends ValueObject
  {
    // ======================================================================
    //  Constants
    // ----------------------------------------------------------------------
    public static const TYPE_ID:uint = TYPE_USHORT;
    public static const CLASS_NAME:String = "ValueUnsignedShortVectorVector";
    
    // ======================================================================
    //  Properties
    // ----------------------------------------------------------------------
    protected var _value:Vector.<Vector.<uint>>;
    ...
    //  Constructor
    // ----------------------------------------------------------------------
    public function ValueUnsignedShortVectorVector( id:uint, container:GenericBinaryContainer, value:Vector.<Vector.<uint>> )
    {
    ...
    override public function getUnsignedShortVectorVector():Vector.<Vector.<uint>>
    {
      return _value;
    }
    
    override public function getUnsignedIntVectorVector():Vector.<Vector.<uint>>
    {
      return _value;
    }
  }
