...
package com.adobe.binary
{
  ...
  //  Class
  // ---------------------------------------------------------------------------
  final internal class ValueUnsignedByteVector extends ValueObject
  {
    // ======================================================================
    //  Constants
    // ----------------------------------------------------------------------
    public static const TYPE_ID:uint = TYPE_UBYTE;
    public static const CLASS_NAME:String = "ValueUnsignedByteVector";
    ...
    //  Constructor
    // ----------------------------------------------------------------------
    public function ValueUnsignedByteVector( id:uint, container:GenericBinaryContainer, value:Vector.<uint> )
    {
    ...
    override public function getUnsignedByteVector():Vector.<uint> { return _value; }
    override public function getUnsignedShortVector():Vector.<uint> { return _value; }
    override public function getUnsignedIntVector():Vector.<uint> { return _value; }
  }
}
