...

{
  ...
  class TIFFImage
  {
    ...
    protected static const ERROR_INVALID_TIFF_BOM:Error =
      new Error( "Invalid TIFF byte order marker." )
    
    protected static const ERROR_INVALID_TIFF_MAGIC_NUMBER:Error =
      new Error( "Invalid TIFF magic number." );
    
    protected static const ERROR_INVALID_TIFF_IFD:Error =
      new Error( "Invalid TIFF Image File Directory." );
  ...
  class DataBlock
  {
    ...
    //  Constants
    // ----------------------------------------------------------------------
    public static const SIGNATURE:uint =
      0x3842494D // "8BIM"
    
    protected static const ERROR_INVALID:Error =
      new Error( "Invalid Photoshop data block." );
